                ...
                <nav className="space-y-3 flex-grow" aria-label="Main navigation">
                    <ul>
                        <li>
                            <Link
                                to="/dashboard"
                                className={`group flex items-center space-x-3 px-4 py-3 rounded-lg bg-gray-700/50 hover:bg-blue-600 transition-all duration-200 transform hover:translate-x-1 hover:shadow-lg${location.pathname === '/dashboard' ? ' bg-blue-600' : ''}`}
                            ...
                            >
                                ...
                                <span className="font-medium text-gray-200 group-hover:text-white transition-colors">Secrets</span>
                            </Link>
                        </li>
                        <li>
                            <Link
                                to="/generate"
                                className={`group flex items-center space-x-3 px-4 py-3 rounded-lg bg-gray-700/50 hover:bg-green-600 transition-all duration-200 transform hover:translate-x-1 hover:shadow-lg${location.pathname === '/generate' ? ' bg-green-600' : ''}`}
                                aria-current={location.pathname === '/generate' ? 'page' : undefined}
                            >
                                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                </svg>
                                <span className="font-medium text-gray-200 group-hover:text-white transition-colors">Generate Password</span>
                            </Link>
                        </li>
                    </ul>
                </nav>
